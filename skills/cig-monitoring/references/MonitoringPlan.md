...
- **Monitor Undesired ADEs** ← `avoid` goals, ADEs from package inserts, case-report risks (e.g. Wernicke encephalopathy), and mechanism-of-action harms (e.g. reduced enjoyment of life).
